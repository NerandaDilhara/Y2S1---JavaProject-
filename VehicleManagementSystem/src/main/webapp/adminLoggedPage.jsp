...
<body>
	...
	<div class="class1">
		<div>
		<a href="editAdmin.jsp"><button class="btn btn-secondary">Edit Profile</button></a>
		<a href="deleteAdmin.jsp"><button class="btn btn-danger">Delete Profile</button></a><br><br>
		</div>
	
		<h3>${requestScope.output}</h3><br>
