...
<div>
	...
	<div class="class1">
		<h3>Login Here</h3><br>
		<a href="customerLogin.jsp"><button class="btn btn-info">Login as Customer</button></a><br><br>
		<a href="staffLogin.jsp"><button class="btn btn-info">Login as Staff</button></a><br><br>
		<a href="adminLogin.jsp"><button class="btn btn-info">Login as Admin</button></a><br><br>
		<a href="managerLogin.jsp"><button class="btn btn-info">Login as Manager</button></a><br>
	</div>
